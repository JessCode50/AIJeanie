...
class APILib{
	 ...
	 */
	public function listaccts($domain="")
	{
		// return "listaccts function was called"; ///////!!!!!!!

		$params = ['search' => $domain, 'searchmethod' => 'regex', 'searchtype' => 'domain'];
		// if( $want )
		// 	$params['want'] = $want;
	...
	{
		// return "listpkgs function was called"; ///////!!!!!!!
	...
	{
		// return "createacct function was called with username: ". $username . ", domain: ". $domain . ", contact email: " . $contact_email; ///////!!!!!!!
	...
	{
		// return "get_domain_info function was called"; ///////!!!!!!!
	...
	{
		// return "count_pops function was called with cpanel user ". $cpanel_user; ///////!!!!!!!
	...
	public function showbw($user)
	{
		return $this->whm_api_call('showbw', ['search' => $user, 'searchtype' => 'user']);
	}

	public function get_information($cpanel_user)
	{
		return $this->cpanel_api_call($cpanel_user, 'ServerInformation', 'get_information', []);

	}

	//Permission required
	//This function determines if your system requires a reboot to apply quotas, software package updates, or kernel updates.
	public function system_needs_reboot()
	{
		return $response = $this->whm_api_call('system_needs_reboot');
	}

	//This function retrieves the system's load average.
	public function systemloadavg()
	{
		return $response = $this->whm_api_call('systemloadavg');
	}

	//Permission Required
	public function get_server_node_status()
	{
		return $this->whm_api_call('get_server_node_status');
	}

	public function get_disk_usage()
	{
		return $this->whm_api_call('get_disk_usage');
	}
	
	public function servicestatus()
	{
		return $this->whm_api_call('servicestatus');
	}

	//Permission Required
	public function getdiskusage()
	{
		return $this->whm_api_call('getdiskusage');
	}

	public function get_usages($cpanel_user)
	{
		return $this->cpanel_api_call($cpanel_user, 'ResourceUsage', 'get_usages', []);
	}

	public function get_quota_info($cpanel_user){
		return $this->cpanel_api_call($cpanel_user, 'Quota', 'get_quota_info', []);	
	}

	public function get_client_settings($cpanel_user){
		return $this->cpanel_api_call($cpanel_user, 'Email', 'get_client_settings', []);	
	}
}
...
// $response = $cpanel->listaccts("example");

// print_r($response);

//403 errors for edison, janus11, janus7, janus9, 