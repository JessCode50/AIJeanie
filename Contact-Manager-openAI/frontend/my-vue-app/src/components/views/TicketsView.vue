      ...
      <div v-else-if="currentView === 'view' && selectedTicket" class="view-ticket">
        ...
        >
          ...
          <div class="ticket-actions">
            ...
            <BaseButton @click="sendTicketToAI" variant="primary" class="ai-button">
              🤖 Send to AI
            </BaseButton>
  ...
  methods: {
    ...
    async sendTicketToAI() {
      ...
      const ticketData = {
        ...
        created_at: this.selectedTicket.created_at,
        updated_at: this.selectedTicket.updated_at,
        tags: this.selectedTicket.tags
      }

      try {
        // Send ticket data to AI and switch to AI view
